...
- расширенные флаги: `has_constant_columns`, `has_high_cardinality_categoricals`, `has_suspicious_id_duplicates`, `has_many_zero_values`.
...
- `has_constant_columns` - есть колонки с одним уникальным значением;
- `has_high_cardinality_categoricals` - есть категориальные колонки с кардинальностью > 90% от числа строк;
- `has_suspicious_id_duplicates` - есть дубликаты в колонках, содержащих "id" в названии;
- `has_many_zero_values` - в числовых колонках более 50% значений равны нулю.
